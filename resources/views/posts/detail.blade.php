...
<body>
    ...
    <div class="container my-5">
        <a class="btn border-dark" href="{{ url('t') }}" role="button"><i class="bi bi-box-arrow-in-left"
                style="color: black"></i>Back</a>
    </div>
    {{-- Back icon end --}}
    ...
    <div class="container my-5">
        ...
        <h1>KMD မိသားစု၏ (၂၂) ကြိမ်မြောက် စုပေါင်းသွေးလှူခြင်</h1>
    </div>
    <div class="container my-5">


        <div class="clearfix">
            <img src="{{ asset('img/csr1.jpg') }}" class="col-md-6 float-md-end mb-3 ms-md-3" alt="...">
            <p>
                KMD မိသားစု၏ (၂၂) ကြိမ်မြောက် စုပေါင်းသွေးလှူခြင်း အစီအစဉ် ကို ၂၉.၁.၂၀၂၄ ရက်နေ့၊ မနက် (၈:၃၀ နာရီမှ ၁၂:၀၀
                နာရီအထိ) အောင်မြင်စွာ ပြုလုပ် ပြီးစီးခဲ့ပါသည်။ စာရင်းပေး ဝန်ထမ်း (၃၁) ဦး ထဲမှဝန်ထမ်း (၂၇) ဦး
                သွေးလှူဒါန်း
                နိုင်ခဲ့ပါသည်။ စုပေါင်းသွေးလှူ ခြင်း အစီအစဉ်အရ (၂၂) ကြိမ်မြောက်အထိ လှူဒါန်းထားသော စာရင်း အား အောက်တွင်
                ဖော်ပြ ထားပါ သည်။ နှစ်အလိုက် စုပေါင်းသွေးလှူသည့်လူဦးရေ မှာ အောက်ပါအတိုင်းဖြစ်ပါသည်။ ၂၀၁၅ ခုနှစ်အတွက်
                (၅၃)
                ဦး၊ ၂၀၁၆ ခုနှစ် အတွက် (၂၁၂) ဦး၊ ၂၀၁၇ ခုနှစ်အတွက် (၂၂၅) ဦး၊ ၂၀၁၈ ခုနှစ်အတွက် (၂၂၅) ဦး၊ ၂၀၁၉
                ခုနှစ်အတွက် (
                ၁၄၃) ဦး၊ ၂၀၂၀ ခုနှစ်အတွက် (၆၇) ဦး၊ ၂၀၂၂ ခုနှစ်အတွက် (၂၃) ဦး၊ ၂၀၂၃ ခုနှစ်အတွက် (၄၆) ဦး၊ ၂၀၂၄
                ခုနှစ်အတွက်
                (၂၇)ဦး စုစုပေါင်း (၁၀၂၁) ဦး ဖြစ်ပါသည်။
            </p>
        </div>
    </div>
    {{-- Main body End --}}
