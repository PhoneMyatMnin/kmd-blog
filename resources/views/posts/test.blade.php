...
<body>
    ...
    <div class="container my-5">
        ...
        <div class="container ms-auto border border-4">
            <div class="container  my -5" id="carousel-container">
                    ...
                    <div class="carousel-inner">
                        <div class="container text-center">
                            <div class="carousel-item active">
                                <div class="row border border border-5">
                                    <div class="col-6 border border-danger" id="news-col">
                                        <div class="border img-fluid">
                                            <img src="{{ asset('img/khathein2023.jpg') }}" class="img-fluid"
                                                alt="...">
                                        </div>
                                    </div>
                                    <div class="col-6 border border-danger" id="news-col">
                                        <div class=" border">
                                            <div class="container">
                                                <h5 class="card-title fw-bold">
                                                    (၂၇) ကြိမ်မြောက် KMD Group of Companies ၏
                                                    စုပေါင်းမဟာ ဘုံကထိန်အလှူတော်မင်္ဂလာ
                                                </h5>
                                            </div>
                                            <div class="container">
                                                <p>(၂၇) ကြိမ်မြောက် KMD Group of Companies ၏ စုပေါင်း
                                                    မဟာဘုံကထိန်
                                                    အလှူတော် မင်္ဂလာကို၂ဝ၂၃ ခုနှစ်၊ နိုဝင်ဘာလ၊ ၂၇ ရက် နံနက် ၉:၃ဝ နာရီ
                                                    တွင်
                                                    လယ်တီမူဝိပဿနာကမ္မဌာန်း ကျောင်းတိုက် တွင် သံဃာတော် များအား ကထိန်
                                                    သင်္ကန်း၊
                                                    ကထိန် ပစ္စည်း၊
                                                    ကထိန်အလှူငွေ များ ကပ်လှူ ပူဇော်ပြီး တရားနာယူ၍ .....</p>

                                            </div>
                                            <p class="card-text"><small class="text-body-secondary">Media 2023
                                                </small> <a href="#" class="btn btn-primary float-end"
                                                    tabindex="-1" role="button" aria-disabled="true">Read
                                                    More</a></p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="carousel-item">
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="card-body">
                                        <h5 class="card-title fw-bold">KMD မိသားစု၏ (၂၂) ကြိမ်မြောက်
                                            စုပေါင်းသွေးလှူခြင်း</h5>
                                        <p class="card-text">KMD မိသားစု၏ (၂၂) ကြိမ်မြောက် စုပေါင်းသွေးလှူခြင်း
                                            အစီအစဉ် ကို
                                            ၂၉.၁.၂၀၂၄ ရက်နေ့၊ မနက် (၈:၃၀ နာရီမှ ၁၂:၀၀ နာရီအထိ) အောင်မြင်စွာ
                                            ပြုလုပ် ပြီးစီးခဲ့ပါသည်။
                                            စာရင်းပေး ဝန်ထမ်း (၃၁) ဦး ထဲမှဝန်ထမ်း (၂၇) ဦး သွေးလှူဒါန်း
                                            နိုင်ခဲ့ပါသည်။
                                            စုပေါင်းသွေးလှူ ခြင်း အစီအစဉ်အရ (၂၂) ကြိမ်မြောက်အထိ လှူဒါန်း .....
                                        </p>
                                        <p class="card-text"><small class="text-body-secondary">Media 2023
                                            </small> <a href="#" class="btn btn-primary float-end"
                                                tabindex="-1" role="button" aria-disabled="true">Read
                ...
                <div class="col-lg-2 col-md-5 text-white">
                    ...
                    <div><a href="https://www.facebook.com/kmd.com.mm/" target="_blank"><svg
                            ...
                            target="_blank"><svg xmlns="http://www.w3.org/2000/svg" width="35" height="35"
                                ...
                                xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor"
                                class="bi bi-telegram text-light m-1" viewBox="0 0 16 16"
